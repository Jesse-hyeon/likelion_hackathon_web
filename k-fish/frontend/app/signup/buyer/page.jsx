...
import { Users, ArrowLeft, Check, MapPin } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50">
      ...
      <header className="bg-white/90 backdrop-blur-sm border-b px-6 py-4">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold">구매업체 회원가입</h1>
          </div>
      ...
      <div className="max-w-2xl mx-auto p-6">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-gray-900">구매업체 정보 입력</h2>
        </div>
