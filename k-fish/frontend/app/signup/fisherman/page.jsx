...
import { Fish, ArrowLeft, Check, MapPin } from 'lucide-react';

export default function FishermanSignupPage() {
  ...
  const handleSubmit = (e) => {
    ...
    // 회원가입 처리 (실제로는 API 호출)
    setCurrentUser({
      id: 'fisherman_' + Date.now(),
      email: 'fisherman@oullim.kr',
      name: formData.representativeName,
      userType: 'fisherman',
      companyName: formData.companyName
    });
    setCurrentMode('fisherman');
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50">
      ...
      <header className="bg-white/90 backdrop-blur-sm border-b px-6 py-4">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold">어민 생산자 회원가입</h1>
          </div>
      ...
      <div className="max-w-2xl mx-auto p-6">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-gray-900">어민 생산자 정보 입력</h2>
        </div>
